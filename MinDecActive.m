function F = MinDecActive(x,t0,tm,p0,pm,v0,vm,umin)
...
F(1) = 0.5*x(1)*t0^2+x(2)*t0+x(3)-v0;
F(2) = (1/6)*x(1)*t0^3+0.5*x(2)*t0^2+x(3)*t0+x(4)-p0;
F(3) = umin*tm+x(5)-vm;
F(4) = 0.5*umin*tm^2+tm*x(5)+x(6)-pm;
